...
"     var intervalometerUrl = '/start?exposure=' + exposure + '&numExposures=' + numExposures + '&exposureDelay=' + exposureDelay + '&focalLength=' + focalLength + '&pixSize=' + pixSize + '&ditherEnabled=' + ditherEnabled +'&disableTracking=' + disableTracking;\n"
